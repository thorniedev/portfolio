...
export const alt = 'Abu Said - Articles & Blog';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '900px' }}>
          ...
          >
            Engineering Articles & Technical Guides
          </h1>
          <p style={{ fontSize: '26px', color: '#8b98a5', lineHeight: 1.4, margin: 0 }}>
            Deep dives on system architecture, web performance, automation, and full-stack software development.
          </p>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: '20px', color: '#8b98a5' }}>abusaid.dev/blog</span>
        </div>
      </div>
    ),
    { ...size }
