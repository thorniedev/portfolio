    ...
    <footer className="border-t border-[#25213b] py-6">
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
        ...
        <div className="flex flex-col items-center sm:items-start gap-1">
          <Link href="/" className="text-[#16f2b3] text-2xl font-bold" aria-label="Kim Chanthorn Homepage">
            KIM CHANTHORN
          </Link>
        ...
        <div className="flex items-center gap-3">
          {socialsData.github && (
            <a href={socialsData.github} target="_blank" rel="noopener noreferrer" aria-label="Kim Chanthorn on GitHub"
              className="text-gray-300 hover:text-[#16f2b3] transition-all hover:scale-110">
              <FaGithub size={20} aria-hidden="true" />
            </a>
          )}
          {socialsData.linkedIn && (
            <a href={socialsData.linkedIn} target="_blank" rel="noopener noreferrer" aria-label="Kim Chanthorn on LinkedIn"
              className="text-gray-300 hover:text-[#16f2b3] transition-all hover:scale-110">
              <FaLinkedin size={20} aria-hidden="true" />
            </a>
          )}
          {socialsData.twitter && (
            <a href={socialsData.twitter} target="_blank" rel="noopener noreferrer" aria-label="Kim Chanthorn on Twitter"
              className="text-gray-300 hover:text-[#16f2b3] transition-all hover:scale-110">
